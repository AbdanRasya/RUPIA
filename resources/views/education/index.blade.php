...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-icon-top:hover { background: var(--bg-page); }
        .page-content { padding: 1.75rem; flex: 1; }
        .main-grid { display: grid; grid-template-columns: 2fr 1fr; gap: 1.5rem; }
        @media (max-width: 960px) { .main-grid { grid-template-columns: 1fr; } }

        .panel { background: var(--card-bg); border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 1.5rem; box-shadow: var(--shadow-sm); }
        ...
        .edu-header h3 { font-size: 0.9rem; font-weight: 600; }
...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ url('/education') }}" class="nav-item active">
    ...
    <div class="main-area">
        <header class="topbar">
            <div class="topbar-left">
                ...
                <p>Pelajari cara mengelola aset dengan cerdas</p>
            </div>
