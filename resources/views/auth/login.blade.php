...
<head>
    ...
    <title>Login | Rupia - Financial Assistant</title>
    <style>
...
<body>
    <div class="auth-container">
        <div class="auth-left">
            ...
            <p class="auth-tagline">Solusi cerdas untuk mengelola keuangan harian, merencanakan masa depan, dan mewujudkan impianmu dengan mudah.</p>
        </div>
            ...
            <div class="form-wrapper">
                ...
                <form action="{{ url('/login') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" class="form-input" placeholder="contoh@email.com" required value="{{ old('email') }}" autofocus>
                    </div>
