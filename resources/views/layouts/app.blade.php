...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .sidebar-bottom { padding: 1rem; border-top: 1px solid var(--border-color); margin-top: auto; }
        .sidebar-user { display: flex; align-items: center; gap: 0.75rem; padding: 0.75rem; border-radius: var(--radius-sm); background: var(--primary-light); margin-bottom: 0.75rem; }
        ...
        .sidebar-user-name { font-size: 0.85rem; font-weight: 600; color: var(--text-main); white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
        .sidebar-user-role { font-size: 0.72rem; color: var(--text-muted); }
        .btn-logout-sidebar { width: 100%; background: var(--danger-light); color: var(--danger); border: 1px solid transparent; padding: 0.6rem 0.75rem; border-radius: var(--radius-sm); font-size: 0.85rem; font-weight: 600; cursor: pointer; display: flex; align-items: center; gap: 0.5rem; transition: 0.2s; font-family: 'Outfit', sans-serif; }
        .btn-logout-sidebar:hover { background: var(--danger); color: #fff; }
...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ url('/history') }}" class="nav-item {{ request()->is('history*') || request()->is('topup*') || request()->is('transaction*') || request()->is('transfer*') || request()->is('pay*') ? 'active' : '' }}">
            ...
            <a href="{{ url('/saving') }}" class="nav-item {{ request()->is('saving*') || request()->is('budgets*') ? 'active' : '' }}">
