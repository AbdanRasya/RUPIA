...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* ── TRANSFER FORM ── */
        .panel { background: var(--card-bg); border: 1px solid var(--border-color); border-radius: var(--radius-lg); padding: 2rem; box-shadow: var(--shadow-sm); max-width: 520px; }
        .form-group { margin-bottom: 1.375rem; }
        .form-label { display: block; font-size: 0.7rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.8px; color: var(--text-muted); margin-bottom: 0.5rem; }

        .input-clean { width: 100%; background: var(--bg-page); border: 1.5px solid var(--border-color); border-radius: var(--radius-md); padding: 0.875rem 1rem; color: var(--text-main); font-size: 0.9rem; outline: none; transition: 0.18s; font-family: 'Inter', sans-serif; }
        .input-clean:focus { border-color: var(--primary); background: #fff; }
        .input-amount { font-size: 1.75rem; font-weight: 800; text-align: center; }

        .btn-confirm { width: 100%; background: var(--primary); color: white; padding: 1rem; border-radius: var(--radius-md); border: none; font-weight: 700; font-size: 0.95rem; cursor: pointer; margin-top: 0.5rem; font-family: 'Inter', sans-serif; transition: 0.2s; }
        .btn-confirm:hover { background: var(--primary-dark); }

        .alert { padding: 0.875rem 1.25rem; border-radius: var(--radius-md); font-size: 0.875rem; font-weight: 600; margin-bottom: 1.25rem; }
...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="{{ url('/transfer') }}" class="nav-item active">
    ...
    <div class="main-area">
        <header class="topbar">
            <div class="topbar-left">
                <h1>Kirim Uang</h1>
                <p>Transfer ke bank atau e-wallet manapun</p>
            </div>
        ...
        <main class="page-content">
            ...
            <form action="{{ url('/transfer/process') }}" method="POST" class="panel">
                ...
                <button type="submit" class="btn-confirm">Konfirmasi Transfer</button>
            </form>
        </main>
    </div>
